...
contract Pausable is Ownable {
    ...
    /**
     * @dev Flag to indicate whether or not a contract is paused
     */
    ...
    /**
     * @dev Change the state of the contract to either paused or unpaused.
     */
...
contract CustomERC721Token is ERC721Metadata {
    ...
    constructor() ERC721Metadata("NAME", "SYMBOL", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") public {
    }
